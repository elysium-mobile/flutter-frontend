...
/// responses into [AuthSessionResponse]. All transport concerns (headers,
/// tokens,
...
class IamWebService {
  ...
  /// first-party [AuthSessionResponse].
  Future<AuthSessionResponse> authenticate(SignInRequest request) async {
